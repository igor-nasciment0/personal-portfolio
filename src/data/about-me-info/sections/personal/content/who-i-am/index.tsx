export default function WhoIAm() {
    return (
        <div className="plain-text">
            ...
            <p>Olá! Me chamo Igor Nascimento, e além de minha paixão pela tecnologia e desenvolvimento de software, tenho uma variedade de interesses e experiências que moldam quem sou fora do mundo profissional.</p>
